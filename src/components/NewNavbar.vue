<template>
 <header class="petHeader fixed inset-x-0 top-0 z-50">
      <nav class="navbar lg:max-w-7xl  mx-auto fixed flex items-center justify-between py-4 " aria-label="Global">
        <div class="flex lg:flex-1">
            <a href="#home" class="hidden md:flex">
            ...
            <a href="#home"  class="flex md:hidden w-12 h-w-12">
        ...
        <DialogPanel class="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto menuMobile bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
          ...
          <div class="mt-6 flow-root">
            <div class="-my-6 divide-y divide-gray-500/10">
              ...
              <div class="py-6">
                <a href="#" class="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-stone-900 hover:bg-gray-50">Log in</a>
              </div>
            </div>
          </div>
        </DialogPanel>
