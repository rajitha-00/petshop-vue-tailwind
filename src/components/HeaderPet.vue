<template>
  <header class="petHeader fixed text-center text-white p-4 mb-10">
    <div class="navbar  text-brown-600 px-6  flex flex-wrap items-center justify-between">
      ...
      <div v-bind:class="{'hidden': !showMenu, 'flex': showMenu}" class="lg:flex ">
        ...
        <!-- <div class="flex items-center md:order-2">
            ...
            <!-- <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600" id="user-dropdown">
              ...
              <ul class="py-2" aria-labelledby="user-menu-button">
                <li>
                  <a href="#" class="block px-4 py-2 text-sm text-yellow-700 hover:bg-yellow-100 dark:hover:bg-yellow-600 dark:text-yellow-200 dark:hover:text-white">Sign out</a>
                </li>
              </ul>
            </div>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="menu" width="35" height="35">
          <g data-name="Layer 2">
            <g data-name="menu-2">
              ...
              <circle cx="4" cy="12" r="1" fill="#3c2c32"></circle>
              <rect width="14" height="2" x="7" y="11" rx=".94" ry=".94" fill="#3c2c32"></rect>
              <rect width="18" height="2" x="3" y="16" rx=".94" ry=".94" fill="#3c2c32"></rect>
              <rect width="18" height="2" x="3" y="6" rx=".94" ry=".94" fill="#3c2c32"></rect>
            </g>
          </g>
        </svg>
      </div>
